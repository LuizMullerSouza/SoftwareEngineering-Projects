...
int main() {
    ...
    // Título
    printf("ENCONTRADOR DO MENOR VALOR ENTRE TRÊS NÚMEROS\n");
    ...
    // Lógica condicional para encontrar o menor número
...
/*
    ...
    mostre o menor deles. Suponha que os três valores sejam diferentes.
*/
